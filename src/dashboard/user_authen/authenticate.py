...
# ------------------------------------
load_dotenv()
COGNITO_DOMAIN = "https://appauthentication.auth.ap-southeast-2.amazoncognito.com"
CLIENT_ID = "40m4fjh5a1bpfv9lvjnsekvpq8"
CLIENT_SECRET = "d5juk4p7e3had9dig7fflpdea4a1v5s8e26n5rm02i7k67rpgsr"
...
logout_link = f"{COGNITO_DOMAIN}/logout?client_id={CLIENT_ID}&redirect_uri={APP_URI}"
html_css_login = """
<style>
.button-login {
